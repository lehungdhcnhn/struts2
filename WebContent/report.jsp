...
<body onload="report();" class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
			...
			<s:submit value="submit" cssClass="btn btn-success" cssStyle="float:right;margin-bottom: 20px" name="submit" />
						...
						<table class="table table-borderless">
							...
							<tr>
								...
								<td style="text-align: center;" scope="col"></td>
								<td style="text-align: center;" scope="col"></td>
								<td style="text-align: center;" scope="col">ToTal:</td>
								<td style="text-align: center;" scope="col"><b><span id="resultTotal"></span></b></td>
								<td style="text-align: center;" scope="col"></td>
							</tr>
						</table>
					</div>
